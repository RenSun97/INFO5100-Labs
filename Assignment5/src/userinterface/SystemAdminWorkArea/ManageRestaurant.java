...
public class ManageRestaurant extends javax.swing.JPanel {
     ...
     */
    public ManageRestaurant(JPanel userProcessContainer,EcoSystem ecosystem) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTrueName = new javax.swing.JTextField();
        ...
        jLabel7.setText("Manage DeliveryMans");
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel3)
                    .addComponent(jTrueName, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(33, 33, 33)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void btnViewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewActionPerformed
        ...
        if (selectedRow >= 0) {
            ...
            String trueName=this.jTrueName.getText();
            ...
            else
            {
                ...
                ecosystem.getUserAccountDirectory().searchUserAccount(username1).setPassword(password);
                ecosystem.getUserAccountDirectory().searchUserAccount(username1).getEmployee().setName(trueName);
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        ...
        if(this.ecosystem.getUserAccountDirectory().checkIfUsernameIsUnique(username))
        {
            ...
            employee.setName(this.jTrueName.getText());
            this.ecosystem.getUserAccountDirectory().createUserAccount(username, password, employee, role);
    ...
    private javax.swing.JTextField jTrueName;
