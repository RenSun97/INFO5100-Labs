...
public class AdminCreateScreen extends javax.swing.JPanel {
   ...
   public AdminCreateScreen(JPanel panelRight, Admin admin) {
    ...
    private void btnCreateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateActionPerformed
        ...
        if("".equals(username)){
            JOptionPane.showMessageDialog(null, "input email account please", "Confirm",JOptionPane.YES_NO_OPTION);
              txtUser.setBackground(Color.RED);
            return;
          
        }
        else {
            boolean b = usernamePatternCorrect();
            if(!b)
            {
                JOptionPane.showMessageDialog(null, "input correct email account", "Confirm",JOptionPane.YES_NO_OPTION);
                txtUser.setBackground(Color.RED);
                return;
        ...
        if("".equals(pwd) )
        {
            JOptionPane.showMessageDialog(null, "input password please", "Confirm",JOptionPane.YES_NO_OPTION);
            txtPword.setBackground(Color.RED);
            return;
        }
        else if (pwd.length()<6 )
        {
            JOptionPane.showMessageDialog(null, "input password at least 6 digitplease", "Confirm",JOptionPane.YES_NO_OPTION);
            txtPword.setBackground(Color.RED);
            return;
        }
            
        else  if ("".equals(repwd))
        {
            JOptionPane.showMessageDialog(null, "repet password please", "Confirm",JOptionPane.YES_NO_OPTION);
            txtPword.setBackground(Color.RED);
            return;
        }
        else {
            boolean b = pwdPatternCorrect();
            if(!b)
            {
                JOptionPane.showMessageDialog(null, "input correct password format please", "Confirm",JOptionPane.YES_NO_OPTION);
                txtPword.setBackground(Color.RED);
                return;
            }
        }
        
        Object[] SelectedObjects = radioCustomer.getSelectedObjects();
        if(SelectedObjects!=null&&SelectedObjects.length==1) {
            Customer customer = new Customer(pwd,username ,date);
            admin.getCustDir().getCustomerList().add(customer);
            JOptionPane.showMessageDialog(null, "Customer Added Successfully");
        }
        else {
            Supplier supplier = new Supplier( pwd,username);
