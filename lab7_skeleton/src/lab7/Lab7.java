...
public class Lab7 {
    ...
    private void runAnalysis() {
        ...
        helper.getMostLikesCommetsPost();
        helper.getMostCommetsPost();
        helper.getTop5InactiveUsersByTotalPostsNumber();
        helper.getTop5InactiveUsersByTotalComments();
        helper.getTop5InactiveUsersByOverall();
        helper.getTop5ProactiveUsersByOverall();
    }
}
